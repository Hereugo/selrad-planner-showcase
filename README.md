...
- [x] сорт даты по возраст
- [x] fix some db issue in worklist
- [x] Показывать список менеджеров ввиде пилюль
- [x] Edit план
- [ ] Включать / выключать колонки в таблице
- [x] Фильтация по дате / поиску
- [x] Функционал скачивания таблицы в формате excel
- [ ] Кнопка "отчет"
- [x] Исправить баг с создании плана с менеджером (M2M)
- [ ] Хостинг
- [ ] Докеризация
