 ...
 */
export function fetchWithAuth<Type>(url: string, config?: AxiosRequestConfig): AxiosPromise<Type> {
 ...
 * @param config any configuration to pass to axios
 */
export function postWithAuth<Type>(url: string, data?: unknown, config?: AxiosRequestConfig): AxiosPromise<Type> {
 ...
 * @param config any configuration to pass to axios
 */
export const putWithAuth = (url: string, data?: unknown, config?: AxiosRequestConfig): AxiosPromise => {
 ...
 * @param config any configuration to pass to axios
 */
export const patchWithAuth = (url: string, data?: unknown, config?: AxiosRequestConfig): AxiosPromise => {
 ...
 * @param config any configuration to pass to axios
 */
export const deleteWithAuth = (url: string, config?: AxiosRequestConfig): AxiosPromise => {
