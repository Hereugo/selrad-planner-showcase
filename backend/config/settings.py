...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'ev%a^8m9l!36)p7zh3lvuey5u9v*z1lv2ews*f*^8-xs%9@xx+')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_DEBUG_LOG', default='./logs/django_debug.log'),
        ...
        'django_requests': {
            'level': 'INFO',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.getenv('DJANGO_REQUESTS_LOG', default='./logs/django_requests.log'),
            'maxBytes': 5 * 1024 * 1024,
            'backupCount': 10,
        },
    },
